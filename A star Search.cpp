...
void aStar_Search(Node* head, Node* s, int size, edge* &e_head, int key_row, int key_col, int goal_row, int goal_col, string** arr)
{
...
int main()
{
	...
	aStar_Search(head, s, size, temp2->e_head, start_key_row, start_key_col, goal_key_row, goal_key_col, arr);
